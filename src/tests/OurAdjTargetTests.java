...
public class OurAdjTargetTests {
	...
	public void testAdjacencyRoomExit()
	{
		...
		Assert.assertTrue(testList.contains(board.getCellAt(4,2)));
		// TEST DOORWAY LEFT 
		...
		Assert.assertEquals(1, testList.size());
		Assert.assertTrue(testList.contains(board.getCellAt(11,19)));
	...
	public void testAdjacencyDoorways()
	{
		...
		Assert.assertTrue(testList.contains(board.getCellAt(3,2)));
		...
		Assert.assertTrue(testList.contains(board.getCellAt(18,6)));
		Assert.assertEquals(4, testList.size());
		// Test beside a door direction UP
		testList = board.getAdjList(11,19);
		Assert.assertTrue(testList.contains(board.getCellAt(12,19)));
		Assert.assertTrue(testList.contains(board.getCellAt(10,19)));
		Assert.assertTrue(testList.contains(board.getCellAt(11,18)));
		Assert.assertEquals(3, testList.size());
	}
	...
	public void testAdjacencyWalkways()
	{
		...
		Assert.assertTrue(testList.contains(board.getCellAt(9,18)));
		Assert.assertTrue(testList.contains(board.getCellAt(10,19)));
		Assert.assertTrue(testList.contains(board.getCellAt(8,19)));
		Assert.assertEquals(4, testList.size());

		testList = board.getAdjList(19,16);
		Assert.assertTrue(testList.contains(board.getCellAt(19,15)));
		Assert.assertTrue(testList.contains(board.getCellAt(18,16)));
		Assert.assertTrue(testList.contains(board.getCellAt(20,16)));
		Assert.assertEquals(3, testList.size());
		
		testList = board.getAdjList(17,22);
		Assert.assertTrue(testList.contains(board.getCellAt(16,22)));
		Assert.assertTrue(testList.contains(board.getCellAt(17,21)));
		Assert.assertEquals(2, testList.size());
		
		testList = board.getAdjList(14,14);
		Assert.assertTrue(testList.contains(board.getCellAt(14, 15)));
		Assert.assertTrue(testList.contains(board.getCellAt(13,14)));
		...
		Assert.assertTrue(testList.contains(board.getCellAt(5,18)));
		Assert.assertEquals(2, testList.size());
	}
	...
	public void testTargetsTwoSteps() {
		...
		Assert.assertTrue(targets.contains(board.getCellAt(2,19)));
	...
	public void testTargetsIntoRoomShortcut() 
	{
		...
		Set<BoardCell> targets= board.getTargets();
		Assert.assertEquals(4, targets.size());
		Assert.assertTrue(targets.contains(board.getCellAt(3,2)));
		Assert.assertTrue(targets.contains(board.getCellAt(4,0)));
		Assert.assertTrue(targets.contains(board.getCellAt(5,1)));
		Assert.assertTrue(targets.contains(board.getCellAt(6,2)));
	...
	public void testRoomExit()
	{
		...
		Assert.assertTrue(targets.contains(board.getCellAt(16,16)));
	}
